...
LID, MOV, ROT, CAN, ARM, LOK, PUM, DRA, _, VAR_SET, VAR_GET, TRACK, _, _, LATCH, ID = range(16)
ORDERS = (
    'LIDAR', 'MOVE', 'ROT', 'CANCEL', 'ARM', 'LOCKERS', 'PUMPS', 'DRAWER', '', 'VAR_SET', 'VAR_GET', 'TRACK',
    '', '', 'LATCH', 'ID'
)
...
TYPES = (
    OTHER, MOVEMENT, MOVEMENT, MOVEMENT, ACTION, ACTION, ACTION, ACTION, None, MOVEMENT, MOVEMENT, MOVEMENT, None, None, OTHER,
    OTHER
)
...
HORIZONTAL_POSITIONS = LEFT_SLOT, MID_SLOT, RIGHT_SLOT = 0, 5650, 11300
TOP = 0
LOWEST_CAKE, CAKE_HEIGHT = -4600, 900
CAKE_HEIGHTS = [-4600, -3700, -2800]
